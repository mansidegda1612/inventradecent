  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginBottom: 24 }}>
        <StatCard label="Today's Sales"    value={fmt(todaySales)}     color={C.green} bg={C.greenBg} icon="↑" sub="Direct revenue today" />
        <StatCard label="Today's Purchase" value={fmt(todayPurchases)} color={C.blue}  bg={C.blueBg}  icon="↓" sub="Stock purchased today" />
