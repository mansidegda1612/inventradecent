...
function buildInvoicePageHTML(data, type, company) {
  ...
  // Rows follow the expense sequence (seq), i.e. the order the amounts were
  // actually applied in — so reading the column top to bottom adds up to the
  // net payable, with CGST/SGST sitting on the post-discount amount.
  const summaryRows = [];
